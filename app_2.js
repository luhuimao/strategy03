...
async function parseUniswapV2PendingTxList(body){
	console.log('=========================================================================================================================')
	console.log(`Parsing Pending Transaction List....`)
	console.log('=========================================================================================================================')
	console.log('\n')
	TRANSCATION_COUNTER++
				...
				$(e).children().each(function(j, e1){
					...
					if (j ==7){
						...
						if (patrn.exec(ethval)) {
							...
							if (ethval > 10) {
								console.log('=========================================================================================================================')
								console.log(`Transferring ETH Amont(卖出ETH的数量): ${ethval} ETH`, )
								console.log('=========================================================================================================================')
								console.log('\n')
...
async function startFun(){
	...
	console.log('=========================================================================================================================')
	console.log(`${sd.format(new Date(), 'YYYY-MM-DD HH:mm:ss')}  Front Running Starting`)
	console.log('=========================================================================================================================')
	console.log('\n')
...
/*
	...
	*/
	...
	if(!items){
		console.log('=========================================================================================================================')
		console.log(`No Matching Transactiong Found`)
		console.log('=========================================================================================================================')
		console.log('\n')
		//startFun();
		return;
	...
	*/
	for(var i = 0; i < items.length; i++){
		...
		if (rel){
			...
			console.log('=========================================================================================================================')
			console.log(`交易类型： ${rel.type}; 交易地址： ${items[i]}`)
			console.log('=========================================================================================================================')
			console.log('\n')
			...
			if (rel.tokenAddr == '0x6B175474E89094C44Da98b954EedeAC495271d0F'){
				console.log('=========================================================================================================================')
				console.log('买入代币为DAI')
				console.log('=========================================================================================================================')
				console.log('\n')
			}

			console.log('=========================================================================================================================')
			console.log(`Transaction No.${sd.format(new Date(), 'YYYYMMDD') + 	TRANSCATION_COUNTER.toString().padStart(5, '0')}`)
			console.log('=========================================================================================================================')
			console.log('\n')

			await swapEthToToken(rel.tokenAddr, 1);
			await swapTokenToEth(rel.tokenAddr);
			/*
			console.log('=========================================================================================================================')
	...
	console.log('=========================================================================================================================')
	console.log(`${sd.format(new Date(), 'YYYY-MM-DD HH:mm:ss')}  Front Running Ending`)
	console.log('=========================================================================================================================')
	console.log('\n')
/*	
